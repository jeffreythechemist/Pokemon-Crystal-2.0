...
FalknerGroup:
	...
	db  12, SKARMORY,  STEEL_WING, SAND_ATTACK, PECK, NO_MOVE
	db -1 ; end
...
WhitneyGroup:
	...
	db 23, KANGASKHAN, COMET_PUNCH, LEER, THUNDERPUNCH, NO_MOVE
...
BugsyGroup:
	...
	db 16, ARIADOS,    POISON_STING, CONSTRICT, LEECH_LIFE, NO_MOVE
	db 16, HERACROSS,  HORN_ATTACK, LEER, COUNTER, NO_MOVE
...
MortyGroup:
	...
	db 25, MISDREAVUS, CONFUSE_RAY, SHADOW_BALL, MEAN_LOOK, PAIN_SPLIT
...
PryceGroup:
	...
	db 40, CLOYSTER,   SPIKES, SUPERSONIC, AURORA_BEAM, SPIKE_CANNON
...
JasmineGroup:
	...
	db 37, MAGNETON,   THUNDERBOLT, SUPERSONIC, SONICBOOM, THUNDER_WAVE
	db 37, SCIZOR,     METAL_CLAW, SWORDS_DANCE, LEER, QUICK_ATTACK
	db 40, STEELIX,    SCREECH, SANDSTORM, ROCK_THROW, IRON_TAIL
	db -1 ; end
...
ChuckGroup:
	...
	db 35, MACHAMP,    CROSS_CHOP, LEER, SWORDS_DANCE, NO_MOVE
...
ClairGroup:
	...
	db 43, DRAGONAIR,  THUNDER_WAVE, SURF, SLAM, DRAGONBREATH
	db 43, DRAGONAIR,  THUNDER_WAVE, THUNDERBOLT, SLAM, DRAGONBREATH
...
Rival1Group:
	...
	db 20, SCYTHER,    QUICK_ATTACK, LEER, FALSE_SWIPE, PURSUIT
	...
	; RIVAL1 (10)
	db "?@", TRAINERTYPE_MOVES
	db 30, SCYTHER,    QUICK_ATTACK, LEER, WING_ATTACK, PURSUIT
	...
	db 36, SCYTHER,    SLASH, LEER, WING_ATTACK, PURSUIT
...
WillGroup:
	...
	db 45, ESPEON,     SAND_ATTACK, SWIFT, MORNING_SUN, PSYCHIC_M
	db 47, JYNX,       DOUBLESLAP, LOVELY_KISS, ICE_PUNCH, PSYCHIC_M
	db 45, EXEGGUTOR,  REFLECT, LEECH_SEED, EGG_BOMB, PSYCHIC_M
	db 47, SLOWKING,   DISABLE, AMNESIA, SWAGGER, PSYCHIC_M
	db 49, XATU,       QUICK_ATTACK, FUTURE_SIGHT, CONFUSE_RAY, PSYCHIC_M
	db -1 ; end
...
BrunoGroup:
	...
	db 49, ONIX,       BIND, EARTHQUAKE, SANDSTORM, ROCK_SLIDE
...
KarenGroup:
	...
	db 48, UMBREON,    SAND_ATTACK, CONFUSE_RAY, CRUNCH, MOONLIGHT
	db 50, TYRANITAR,  CRUNCH, SWORDS_DANCE, EARTHQUAKE, SANDSTORM
	db 48, GENGAR,     SHADOW_BALL, SPITE, CURSE, DESTINY_BOND
	db 50, MURKROW,    QUICK_ATTACK, WHIRLWIND, PURSUIT, FAINT_ATTACK
	db 52, HOUNDOOM,   SUNNY_DAY, SOLARBEAM, FLAMETHROWER, CRUNCH
	db -1 ; end
...
KogaGroup:
	...
	db 46, ARIADOS,    DOUBLE_TEAM, SPIDER_WEB, BATON_PASS, GIGA_DRAIN
	db 48, VENOMOTH,   SUPERSONIC, GUST, PSYCHIC_M, TOXIC
	db 46, FORRETRESS, PROTECT, SWIFT, EXPLOSION, SPIKES
	db 48, MUK,        MINIMIZE, ACID_ARMOR, SLUDGE_BOMB, TOXIC
	db 50, NIDOKING,   EARTHQUAKE, SLUDGE_BOMB, THUNDERPUNCH, FIRE_PUNCH
	db -1 ; end
...
ChampionGroup:
	...
	db 53, DRAGONITE,  THUNDER_WAVE, TWISTER, BLIZZARD, HYPER_BEAM
...
BrockGroup:
	...
	db 48, GRAVELER,   DEFENSE_CURL, ROCK_SLIDE, ROLLOUT, EARTHQUAKE
	db 49, RHYHORN,    FURY_ATTACK, SCARY_FACE, EARTHQUAKE, HORN_DRILL
	db 48, OMASTAR,    BITE, SURF, PROTECT, SPIKE_CANNON
...
ScientistGroup:
	...
	; SCIENTIST (5)
	db "HOLDEN@", TRAINERTYPE_MOVES
	db 25, UMBREON,    BITE, SAND_ATTACK, CONFUSE_RAY, NO_MOVE
	db 27, URSARING,   LEER, FURY_SWIPES, FAINT_ATTACK, NO_MOVE
	db 25, DRAGONITE,  THUNDER_WAVE, WRAP, TWISTER, NO_MOVE
	db -1 ; end
...
ErikaGroup:
	...
	db 58, JUMPLUFF,   MEGA_DRAIN, LEECH_SEED, COTTON_SPORE, GIGA_DRAIN
	db 58, VICTREEBEL, SUNNY_DAY, SYNTHESIS, ACID, RAZOR_LEAF
	db 63, BELLOSSOM,  SUNNY_DAY, SYNTHESIS, PETAL_DANCE, SOLARBEAM
	db -1 ; end
...
Rival2Group:
	...
	db 42, SCIZOR,     SWORDS_DANCE, METAL_CLAW, LEER, SLASH
	...
	db 48, SCIZOR,     SWORDS_DANCE, METAL_CLAW, LEER, SLASH
...
RedGroup:
	...
	db 99, PIKACHU,   CHARM, THUNDER_WAVE, THUNDERBOLT, THUNDER
	db 83, ESPEON,     MORNING_SUN, REFLECT, SWIFT, PSYCHIC_M
	db 85, SNORLAX,    AMNESIA, SNORE, REST, BODY_SLAM
	db 88, VENUSAUR,   SUNNY_DAY, GIGA_DRAIN, LEECH_SEED, SOLARBEAM
	db 88, CHARIZARD,  FLAMETHROWER, WING_ATTACK, EARTHQUAKE, FIRE_SPIN
	db 88, BLASTOISE,  RAIN_DANCE, SURF, BLIZZARD, WHIRLPOOL
	db -1 ; end
...
BlueGroup:
	...
	db 68, ARCANINE,   FIRE_SPIN, SWIFT, FLAMETHROWER, EXTREMESPEED
	db -1 ; end
